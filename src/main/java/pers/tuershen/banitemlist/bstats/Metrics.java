package pers.tuershen.banitemlist.bstats;
...
public class Metrics {
    ...
    static  {
        if (System.getProperty("bstats.relocatecheck") == null || !System.getProperty("bstats.relocatecheck").equals("false")) {
            ...
            if (Metrics.class.getPackage().getName().equals(defaultPackage) || Metrics.class.getPackage().getName().equals(examplePackage)) {
                throw new IllegalStateException("bStats! 重新定位");
            }
        }
    }
    ...
    public Metrics(Plugin plugin, int pluginId) {
        ...
        if (this.enabled) {
            ...
            Bukkit.getServicesManager().register(Metrics.class, this, this.plugin, ServicePriority.Normal);
            if (!found)
            {
                startSubmitting();
            }
                ...
                for (RegisteredServiceProvider<?> provider : Bukkit.getServicesManager().getRegistrations(service)) {
                    try {
                        ...
                        if (plugin instanceof JsonObject) {
                            pluginData.add((JsonElement)plugin); continue;
                        }
                        try {
        ...
        protected JsonObject getChartData() throws Exception {
            ...
            for (Map.Entry<String, int[]> entry : map.entrySet()) {
                ...
                for (int categoryValue : (int[])entry.getValue()) {
                    categoryValues.add(new JsonPrimitive(Integer.valueOf(categoryValue)));
                }
