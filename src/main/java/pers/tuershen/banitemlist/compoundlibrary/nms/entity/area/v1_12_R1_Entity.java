package pers.tuershen.banitemlist.compoundlibrary.nms.entity.area;
...
public class v1_12_R1_Entity extends MinecraftEntity {


    private static Method save;

    public v1_12_R1_Entity(Entity entity) {
        super(entity);
    }
