...
public class SerializableStream {
     ...
     * @return
     */
    public static String getByteStream(pers.tuershen.banitemlist.compoundlibrary.nms.io.SerializableFormat serializableFormat) {
        try {
     ...
     * @return
     */
    public static pers.tuershen.banitemlist.compoundlibrary.nms.io.SerializableFormat deserializeObj(String data) {
        ByteArrayInputStream byteStream = decodeByteInputStream(data);
        ObjectInputStream ois = null;
        try {
            ois = new ObjectInputStream(byteStream);
            pers.tuershen.banitemlist.compoundlibrary.nms.io.SerializableFormat obj = (SerializableFormat)ois.readObject();
            return obj;
        }
