package pers.tuershen.banitemlist.compoundlibrary.nms.nbt;
...
public abstract class TagBase implements Serializable {
    ...
    public static void intiFactoryClass(String version){
        ...
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagByte"      , byte.class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagByteArray" , byte[].class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagDouble"    , double.class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagFloat"     , float.class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagInt"       , int.class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagIntArray"  , int[].class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagLong"      , long.class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagLongArray" , long[].class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagShort"     , short.class);
        nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagString"    , String.class);
        try {
            if (version.contains("v1_12")){
                nbtTagLongArray     = Class.forName("net.minecraft.server." + version + ".NBTTagLongArray");
            }
            nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagList"    ,      Class.forName("net.minecraft.server." + version + ".NBTBase"));
            nmsFactory.put("pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagCompound",      Class.forName("net.minecraft.server." + version + ".NBTBase"));
    ...
    protected static <T> String getNmsNBTTagType(Class<T> clazz) {
        switch (clazz.getTypeName()) {
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagByte":
                return "setByte";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagByteArray":
                return "setByteArray";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagDouble":
                return "setDouble";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagFloat":
                return "setFloat";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagInt":
                return "setInt";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagIntArray":
                return "setIntArray";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagLong":
                return "setLong";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagLongArray":
                return "setLongArray";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagShort":
                return "setShort";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagString":
                return "setString";
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagCompound":
            case "pers.tuershen.banitemlist.compoundlibrary.nms.nbt.TagList":
                return "set";
        }
        return null;
    }
